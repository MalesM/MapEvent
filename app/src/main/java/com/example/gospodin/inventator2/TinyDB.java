...
public class TinyDB {
    ...
    public ArrayList<MarkerClass> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<MarkerClass> objects =  new ArrayList<>();

    	for(String jObjString : objStrings){
    		MarkerClass value  = (MarkerClass) gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<MarkerClass> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(MarkerClass obj : objArray){
